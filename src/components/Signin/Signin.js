...
class Signin extends React.Component {
	...
	onSubmitSignIn = () => {
		//console.log('in Sign.js, in function onSubmitSignin')
		fetch('https://mysterious-ocean-64414.herokuapp.com/signin', {
			method: 'post',
			...
			.then(user => {
				if (user.id){			
					//console.log('in onSubmitSignIn, user from server is ', user);
